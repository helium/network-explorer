...
export default async function Page({ params }: { params: { hexId: string } }) {
  ...
  return (
    <div
      className={clsx(
        "absolute bottom-6 left-4 right-4 top-24 z-50 flex w-auto flex-col gap-4 rounded-xl px-4 py-2 text-sm font-medium shadow-lg shadow-zinc-800/5 ring-1 backdrop-blur-sm sm:bottom-auto sm:left-6 sm:right-auto sm:top-24 sm:max-h-[calc(100vh-10rem)] sm:w-80",
