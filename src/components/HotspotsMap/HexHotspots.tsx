                    ...
                    <div className="group relative flex items-center px-2 py-3">
                      ...
                      >
                        ...
                        <div className="relative flex min-w-0 flex-1 items-center gap-4">
                          ...
                          <div className="">
                            <p className="block truncate text-sm font-medium leading-6 text-gray-900 dark:text-zinc-100">
                              {hotspotName}
                            </p>
                            <span className="leading-2 block truncate text-xs font-normal text-gray-600 dark:text-zinc-300">
                              {subtitle}
                            </span>
                          </div>
                        </div>
