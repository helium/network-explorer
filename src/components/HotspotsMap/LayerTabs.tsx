        ...
        {layerOptions.map((option) => {
          ...
          return (
            <Tab
              key={name}
              className={clsx(
                "font-semi-bold flex w-full cursor-pointer items-center gap-2 rounded-xl px-3 py-1.5 text-sm leading-5 ring-opacity-60 ring-offset-1 transition focus:outline-none focus:ring-2 ui-selected:shadow",
                ...
                "dark:ring-white dark:ring-offset-gray-400 ui-selected:dark:bg-zinc-500/30 ui-selected:dark:text-white ui-not-selected:dark:text-zinc-300 ui-not-selected:dark:hover:bg-zinc-700"
              )}
            >
